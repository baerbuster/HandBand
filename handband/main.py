...
# Everything below lives inside main() rather than at module level, so
# that importing this module does not construct a Tk window and block in
# mainloop(). A test collector or CI job that merely reads this file
# would otherwise hang until something closed the window.
